...
char *mu_1_MessageType::values[] = {"GetS","GetM","PutS","PutM","Data","Fwd_GetS","Fwd_GetM","Fwd_GetM_A","Inv","Put_Ack","Inv_Ack",NULL };
...
class mu_1__type_1: public mu__byte
{
 public:
  ...
  mu_1__type_1 (char *name, int os): mu__byte(18, 23, 3, name, os) {};
...
char *mu_1__type_1::values[] = {"H_I","H_S","H_M","H_MtoS_D","H_MtoM_A","H_StoM_A",NULL };
...
class mu_1__type_4: public mu__byte
{
 public:
  ...
  {
    if (val.defined())
      return ( s << mu_1__type_4::values[ int(val) - 24] );
    else return ( s << "Undefined" );
  };

  mu_1__type_4 (char *name, int os): mu__byte(24, 34, 4, name, os) {};
  mu_1__type_4 (void): mu__byte(24, 34, 4) {};
  mu_1__type_4 (int val): mu__byte(24, 34, 4, "Parameter or function result.", 0)
  {
     operator=(val);
  };
...
char *mu_1__type_4::values[] = {"P_I","P_S","P_M","P_ISD","P_IMAD","P_IMA","P_SMAD","P_SMA","P_MIA","P_SIA","P_IIA",NULL };
...
const int mu_Fwd_GetM_A = 14;
const int mu_Inv = 15;
const int mu_Put_Ack = 16;
const int mu_Inv_Ack = 17;
const int mu_H_I = 18;
const int mu_H_S = 19;
const int mu_H_M = 20;
const int mu_H_MtoS_D = 21;
const int mu_H_MtoM_A = 22;
const int mu_H_StoM_A = 23;
const int mu_P_I = 24;
const int mu_P_S = 25;
const int mu_P_M = 26;
const int mu_P_ISD = 27;
const int mu_P_IMAD = 28;
const int mu_P_IMA = 29;
const int mu_P_SMAD = 30;
const int mu_P_SMA = 31;
const int mu_P_MIA = 32;
const int mu_P_SIA = 33;
const int mu_P_IIA = 34;
...
bool Condition(unsigned r)
{
  ...
  if (r>=38 && r<=43) return R4.Condition(r-38);
  if (r>=44 && r<=49) return R5.Condition(r-44);
  if (r>=50 && r<=52) return R6.Condition(r-50);
  if (r>=53 && r<=58) return R7.Condition(r-53);
...
void Code(unsigned r)
{
  ...
  if (r>=38 && r<=43) { R4.Code(r-38); return; } 
  if (r>=44 && r<=49) { R5.Code(r-44); return; } 
  if (r>=50 && r<=52) { R6.Code(r-50); return; } 
  if (r>=53 && r<=58) { R7.Code(r-53); return; } 
}
int Priority(unsigned short r)
{
  ...
  if (r>=38 && r<=43) { return R4.Priority(); } 
  if (r>=44 && r<=49) { return R5.Priority(); } 
  if (r>=50 && r<=52) { return R6.Priority(); } 
  if (r>=53 && r<=58) { return R7.Priority(); } 
}
char * Name(unsigned r)
{
  ...
  if (r>=38 && r<=43) return R4.Name(r-38);
  if (r>=44 && r<=49) return R5.Name(r-44);
  if (r>=50 && r<=52) return R6.Name(r-50);
  if (r>=53 && r<=58) return R7.Name(r-53);
  return NULL;
}
};
...
/********************
  Invariant records
 ********************/
int mu__invariant_22() // Invariant "H_I implies no cache has valid data"
{
bool mu__boolexpr23;
  if (!((mu_HomeNode.mu_state) == (mu_H_I))) mu__boolexpr23 = TRUE ;
  else {
bool mu__quant24; 
mu__quant24 = TRUE;
{
...
bool mu__boolexpr25;
  if ((mu_Procs[mu_p].mu_state) == (mu_P_S)) mu__boolexpr25 = TRUE ;
  else {
  mu__boolexpr25 = ((mu_Procs[mu_p].mu_state) == (mu_P_M)) ; 
}
if ( !(!(mu__boolexpr25)) )
  { mu__quant24 = FALSE; break; }
};
};
  mu__boolexpr23 = (mu__quant24) ; 
}
return mu__boolexpr23;
};

bool mu__condition_26() // Condition for Rule "H_I implies no cache has valid data"
{
...
int mu__invariant_27() // Invariant "P_S not with H_M"
{
bool mu__quant28; 
mu__quant28 = TRUE;
{
for(int mu_p = 1; mu_p <= 3; mu_p++) {
bool mu__boolexpr29;
  if (!((mu_Procs[mu_p].mu_state) == (mu_P_S))) mu__boolexpr29 = TRUE ;
  else {
  mu__boolexpr29 = ((mu_HomeNode.mu_state) != (mu_H_M)) ; 
}
if ( !(mu__boolexpr29) )
...
bool mu__condition_30() // Condition for Rule "P_S not with H_M"
{
...
int mu__invariant_31() // Invariant "sharer list soundness (no I/M)"
{
bool mu__quant32; 
mu__quant32 = TRUE;
{
for(int mu_p = 1; mu_p <= 3; mu_p++) {
bool mu__boolexpr33;
  if (!(mu_IsSharer( (int)mu_p ))) mu__boolexpr33 = TRUE ;
  else {
bool mu__boolexpr34;
  if ((mu_Procs[mu_p].mu_state) == (mu_P_I)) mu__boolexpr34 = TRUE ;
  else {
  mu__boolexpr34 = ((mu_Procs[mu_p].mu_state) == (mu_P_M)) ; 
}
...
bool mu__condition_35() // Condition for Rule "sharer list soundness (no I/M)"
{
...
int mu__invariant_36() // Invariant "at most one modified"
{
bool mu__quant37; 
mu__quant37 = TRUE;
{
...
bool mu__boolexpr39;
bool mu__boolexpr40;
  if (!((mu_n1) != (mu_n2))) mu__boolexpr40 = FALSE ;
  else {
  mu__boolexpr40 = ((mu_Procs[mu_n1].mu_state) == (mu_P_M)) ; 
}
  if (!(mu__boolexpr40)) mu__boolexpr39 = TRUE ;
  else {
  mu__boolexpr39 = ((mu_Procs[mu_n2].mu_state) != (mu_P_M)) ; 
}
if ( !(mu__boolexpr39) )
...
bool mu__condition_41() // Condition for Rule "at most one modified"
{
...
int mu__invariant_42() // Invariant "modified value matches last write"
{
bool mu__quant43; 
mu__quant43 = TRUE;
{
...
bool mu__boolexpr44;
  if (!((mu_Procs[mu_n].mu_state) == (mu_P_M))) mu__boolexpr44 = TRUE ;
  else {
...
bool mu__condition_45() // Condition for Rule "modified value matches last write"
{
...
int mu__invariant_46() // Invariant "value in shared state matches memory"
{
bool mu__quant47; 
mu__quant47 = TRUE;
{
...
bool mu__boolexpr48;
bool mu__boolexpr49;
  if (!((mu_HomeNode.mu_state) == (mu_H_S))) mu__boolexpr49 = FALSE ;
  else {
  mu__boolexpr49 = ((mu_Procs[mu_n].mu_state) == (mu_P_S)) ; 
}
...
bool mu__condition_50() // Condition for Rule "value in shared state matches memory"
{
...
int mu__invariant_51() // Invariant "invalid implies no sharers"
{
bool mu__boolexpr52;
...
bool mu__condition_54() // Condition for Rule "invalid implies no sharers"
{
...
int mu__invariant_55() // Invariant "modified implies no sharers"
{
bool mu__boolexpr56;
  if (!((mu_HomeNode.mu_state) == (mu_H_M))) mu__boolexpr56 = TRUE ;
  else {
...
bool mu__condition_58() // Condition for Rule "modified implies no sharers"
{
...
int mu__invariant_63() // Invariant "value in memory matches last write when invalid"
{
bool mu__boolexpr64;
  if (!((mu_HomeNode.mu_state) == (mu_H_I))) mu__boolexpr64 = TRUE ;
  else {
  mu__boolexpr64 = ((mu_HomeNode.mu_val) == (mu_LastWrite)) ; 
}
return mu__boolexpr64;
};

bool mu__condition_65() // Condition for Rule "value in memory matches last write when invalid"
{
...
int mu__invariant_66() // Invariant "Shared implies empty owner"
{
bool mu__boolexpr67;
  if (!((mu_HomeNode.mu_state) == (mu_H_S))) mu__boolexpr67 = TRUE ;
  else {
  mu__boolexpr67 = (mu_HomeNode.mu_owner.isundefined()) ; 
}
return mu__boolexpr67;
};

bool mu__condition_68() // Condition for Rule "Shared implies empty owner"
{
...
int mu__invariant_69() // Invariant "Modified implies defined owner"
{
bool mu__boolexpr70;
  if (!((mu_HomeNode.mu_state) == (mu_H_M))) mu__boolexpr70 = TRUE ;
  else {
...
bool mu__condition_71() // Condition for Rule "Modified implies defined owner"
{
...
int mu__invariant_72() // Invariant "Invalid implies empty owner"
{
bool mu__boolexpr73;
  if (!((mu_HomeNode.mu_state) == (mu_H_I))) mu__boolexpr73 = TRUE ;
  else {
  mu__boolexpr73 = (mu_HomeNode.mu_owner.isundefined()) ; 
}
return mu__boolexpr73;
};

bool mu__condition_74() // Condition for Rule "Invalid implies empty owner"
{
...
{"Invalid implies empty owner", &mu__condition_74, NULL, FALSE},
{"Modified implies defined owner", &mu__condition_71, NULL, FALSE},
{"Shared implies empty owner", &mu__condition_68, NULL, FALSE},
{"value in memory matches last write when invalid", &mu__condition_65, NULL, FALSE},
{"value is undefined while invalid", &mu__condition_62, NULL, FALSE},
{"modified implies no sharers", &mu__condition_58, NULL, FALSE},
{"invalid implies no sharers", &mu__condition_54, NULL, FALSE},
{"value in shared state matches memory", &mu__condition_50, NULL, FALSE},
{"modified value matches last write", &mu__condition_45, NULL, FALSE},
{"at most one modified", &mu__condition_41, NULL, FALSE},
{"sharer list soundness (no I/M)", &mu__condition_35, NULL, FALSE},
{"P_S not with H_M", &mu__condition_30, NULL, FALSE},
{"H_I implies no cache has valid data", &mu__condition_26, NULL, FALSE},
};
const unsigned short numinvariants = 13;
