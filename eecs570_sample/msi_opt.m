...
----------------------------------------------------------------------
const
  ProcCount: 3;          -- number processors, def:P0 & P1 are home
  HomeCount: 2;          -- number home
  ValueCount: 1;         -- number of data values.
  AddrCount: 2;          -- number of address
  D2H_REQ2: 6;           -- cleanevictnodata
  D2H_REQ: 0;
  H2D_REQ: 1;
  D2H_DATA: 2;
  D2H_RSP: 3;
...
type
  ...
  Value: 0..ValueCount-1; -- arbitrary values for tracking coherence
  Address: 0..AddrCount-1; 
...
var
  ...
  LastWrites: array [Address] of Value; -- Used to confirm that writes to addr 0 are not lost;
----------------------------------------------------------------------
-- Procedures
----------------------------------------------------------------------
...
Begin
  put "Unhandled message type at node ";
  put n;               
  put "\n";
  ...
  */
  ...
  case HT_EI_D:
    ...
    case Data:
      ...
      case CleanEvict:
        Assert (HomeNodes[h].request_pre = 0) "HT_EI_D CleanEvict type, Data received, reqeust_pre should be 0";
        hs  := H_I;
        hv  := msg.val;
        undefine HomeNodes[h].request_type;
        undefine HomeNodes[h].requester;
        ...
        undefine HomeNodes[h].owner;
      case DirtyEvict:
        Assert (HomeNodes[h].request_pre = 0) "HT_EI_D DirtyEvict type, Data received, reqeust_pre should be 0";
        hs  := H_I;
        hv  := msg.val;
        undefine HomeNodes[h].request_type;
        undefine HomeNodes[h].requester;
    ...
    case CleanEvict:
      ...
      switch HomeNodes[h].request_type
        case RdOwn:
          ...
          -- msg.uqid, 1);
        case RdCurr:
          if HomeNodes[h].snp_cur_sent = 1 then
             msg_processed := false;
          else
  ...
  case HT_ES_AD:
    ...
    case CleanEvictNoData:
      ...
      case RdShared:
        ...
        --   msg_processed := false;
        -- else
          if HomeNodes[h].snp_data_sent = 1 then
            Send(GO, HomeNodes[h].requester , h, H2D_RSP, UNDEFINED, UNDEFINED, 
            msg.uqid, UNDEFINED, UNDEFINED, UNDEFINED, UNDEFINED, UNDEFINED, UNDEFINED,
            I, 1);
...
--  put " at proc "; put p; put "\n";
  ...
  case PT_II_WP:
    ...
    case WritePull:
      ...
      UNDEFINED, UNDEFINED);
      if msg.src = Home0 then
        LastWrites[0] := Procs[p].mem_write_val;
      else
        LastWrites[1] := Procs[p].mem_write_val;
      endif;
  ...
  case PT_MI_GP:
    ...
    case SnpData:
      ...
      -- UNDEFINED, msg.uqid, 0, 0, UNDEFINED, 0, UNDEFINED,
      -- UNDEFINED, UNDEFINED);
      -- Send(RspSFwdM, msg.src, p, D2H_RSP, UNDEFINED, UNDEFINED, 
      -- UNDEFINED, msg.uqid, UNDEFINED, UNDEFINED, UNDEFINED, UNDEFINED, UNDEFINED,
      -- UNDEFINED, UNDEFINED);
      ps  := P_I;
    ...
    case SnpInv:
      ...
      -- UNDEFINED, msg.uqid, 0, 0, UNDEFINED, 0, UNDEFINED,
      -- UNDEFINED, UNDEFINED);
      -- Send(RspIFwdM, msg.src, p, D2H_RSP, UNDEFINED, UNDEFINED, 
      -- UNDEFINED, msg.uqid, UNDEFINED, UNDEFINED, UNDEFINED, UNDEFINED, UNDEFINED,
      -- UNDEFINED, UNDEFINED);
...
ruleset ad: Address do  
  ...
  ==>
    p.state := PT_EI_GP;      
      if p.addr = 0 then
        Send(CleanEvict, Home0, n, D2H_REQ2, UNDEFINED, ad,
        id, UNDEFINED, 0, UNDEFINED, UNDEFINED, UNDEFINED, UNDEFINED, 
        UNDEFINED, UNDEFINED);
      else
        Send(CleanEvict, Home1, n, D2H_REQ2, UNDEFINED, ad,
        id, UNDEFINED, 0, UNDEFINED, UNDEFINED, UNDEFINED, UNDEFINED, 
        UNDEFINED, UNDEFINED);
      endif;
  endrule;
  ...
  ==>
    p.state := PT_EI_GOI;    
      if p.addr = 0 then
        Send(CleanEvictNoData, Home0, n, D2H_REQ2, UNDEFINED, ad,
        id, UNDEFINED, 0, UNDEFINED, UNDEFINED, UNDEFINED, UNDEFINED, 
        UNDEFINED, UNDEFINED);
      else
        Send(CleanEvictNoData, Home1, n, D2H_REQ2, UNDEFINED, ad,
        id, UNDEFINED, 0, UNDEFINED, UNDEFINED, UNDEFINED, UNDEFINED, 
        UNDEFINED, UNDEFINED);
      endif;
  endrule;
  ...
  rule "device in state M, send DirtyEvict"
    ...
    ==>
      p.state := PT_MI_GP;
      if p.addr = 0 then
        Send(DirtyEvict, Home0, n, D2H_REQ2, p.val, ad, 
        id, UNDEFINED, 0, UNDEFINED, UNDEFINED, UNDEFINED, UNDEFINED,
        UNDEFINED, UNDEFINED);
      else
        Send(DirtyEvict, Home1, n, D2H_REQ2, p.val, ad, 
        id, UNDEFINED, 0, UNDEFINED, UNDEFINED, UNDEFINED, UNDEFINED,
        UNDEFINED, UNDEFINED);
      endif;
  endrule;
...
startstate
	...
	LastWrites[0] := HomeNodes[Home0].val;
  LastWrites[1] := HomeNodes[Home1].val;
...
invariant "value in addr0 matches value of last write, when invalid"
  -- Forall h : Home Do	
    ...
    ->
			HomeNodes[Home0].val = LastWrites[0];
  -- end;
...
invariant "value in addr1 matches value of last write, when invalid"
  -- Forall h : Home Do	
    ...
    ->
			HomeNodes[Home1].val = LastWrites[1];
  -- end;

-- Here are some invariants that ars[1] helpful for validating shared state.
